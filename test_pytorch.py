...
# from benchmarks.operator_benchmark.pt import configs

"""
Microbenchmarks for qConv operators.
"""

class QConv1dBenchmark():
...
if __name__ == "__main__":
    ...
    test_qconv = QConv1dBenchmark()
    test_qconv.init(IC=16, OC=64, kernel=1, stride=1, N=16, L=64, device='cpu')
    in_data = torch.randn(16,64,64)
    test_qconv.forward(in_data)
